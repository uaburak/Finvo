    ...
    static let defaults: [Category] = [
        ...
        Category(
            ...
            subCategories: [
                ...
                SubCategory(name: "Airbnb / Kısa Süreli Kiralama", icon: "bed.double.fill", colorHex: "#FF385C"),
        ...
        Category(
            ...
            subCategories: [
                ...
                SubCategory(name: "Piyango / Ödül", icon: "sparkles", colorHex: "#FF2D55"),
                SubCategory(name: "Burs / Devlet Yardımı", icon: "studentdesk", colorHex: "#32ADE6")
            ]
        ),
        ...
        Category(
            ...
            colorHex: "#AF52DE", // Mor
            type: .expense,
            subCategories: [// AI & Teknoloji Araçları
        ...
        SubCategory(name: "Microsoft 365 (OneDrive)", icon: "grid.circle.fill", colorHex: "#D83B01"),
        ...
        SubCategory(name: "Steam (EA Play vb.)", icon: "desktopcomputer", colorHex: "#171A21"),
        SubCategory(name: "Twitch (Sub)", icon: "video.fill", colorHex: "#9146FF"),
        
        // İş, Tasarım & Verimlilik
        ...
        SubCategory(name: "Slack Pro", icon: "bubble.right.fill", colorHex: "#4A154B"),
        ...
        // Eğitim & Dil
        SubCategory(name: "Udemy (Abonelik)", icon: "book.closed.fill", colorHex: "#A435F0"),
        ...
        Category(
            ...
            subCategories: [
                ...
                SubCategory(name: "Kasap / Manav / Şarküteri", icon: "carrot.fill", colorHex: "#34C759"),
                SubCategory(name: "Restoran / Akşam Yemeği", icon: "fork.knife", colorHex: "#FF3B30"),
                SubCategory(name: "Kafe / Kahve", icon: "cup.and.saucer.fill", colorHex: "#A2845E"),
                SubCategory(name: "Hızlı Yemek (Fast Food)", icon: "takeoutbag.and.cup.and.straw.fill", colorHex: "#FFCC00"),
                SubCategory(name: "Eve Sipariş (Getir/Yemeksepeti)", icon: "motorcycle.fill", colorHex: "#FF2D55"),
        ...
        Category(
            ...
            type: .expense,
            subCategories: [
                SubCategory(name: "Akaryakıt (Benzin/Dizel)", icon: "fuelpump.fill", colorHex: "#FF3B30"),
                SubCategory(name: "Elektrikli Araç Şarj", icon: "bolt.car.fill", colorHex: "#34C759"),
                ...
                SubCategory(name: "Otopark / HGS / Köprü", icon: "p.circle.fill", colorHex: "#8E8E93"),
        ...
        Category(
            ...
            subCategories: [
                ...
                SubCategory(name: "Konut Kredisi Taksiti", icon: "key.fill", colorHex: "#30B0C7"),
                ...
                SubCategory(name: "Beyaz Eşya / Küçük Ev Aletleri", icon: "washer.fill", colorHex: "#5AC8FA"),
                SubCategory(name: "Bahçe / Balkon Bakımı", icon: "leaf.fill", colorHex: "#34C759")
            ]
        ),
        Category(
            name: "Sağlık & Bakım",
            ...
            subCategories: [
                ...
                SubCategory(name: "Psikolojik Danışmanlık", icon: "face.smiling.fill", colorHex: "#32ADE6"),
                SubCategory(name: "Kişisel Bakım (Kuaför/Berber)", icon: "scissors", colorHex: "#AC8E68"),
                SubCategory(name: "Kozmetik / Parfüm", icon: "sparkles", colorHex: "#FF9F0A"),
                SubCategory(name: "Spor Salonu / Fitness", icon: "figure.strengthtraining.traditional", colorHex: "#34C759")
            ]
        ),
        Category(
            ...
            subCategories: [
                ...
                SubCategory(name: "Aksesuar / Takı / Saat", icon: "watch.analog", colorHex: "#FFD60A"),
                SubCategory(name: "Hobi / Oyun / Oyuncak", icon: "puzzlepiece.fill", colorHex: "#FF9500"),
        ...
        Category(
            ...
            type: .expense,
            subCategories: [
                SubCategory(name: "Sinema / Tiyatro / Konser", icon: "popcorn.fill", colorHex: "#FF375F"),
                SubCategory(name: "Gece Hayatı / Bar / Pub", icon: "wineglass.fill", colorHex: "#5856D6"),
                SubCategory(name: "Tatil / Konaklama", icon: "bed.double.fill", colorHex: "#30B0C7"),
                SubCategory(name: "Uçak / Otobüs / Tren Bileti", icon: "airplane", colorHex: "#007AFF"),
                SubCategory(name: "Müze / Sergi / Kültür", icon: "building.columns.fill", colorHex: "#AC8E68")
            ]
        ),
        Category(
            name: "Evcil Hayvan",
            ...
            subCategories: [
                ...
                SubCategory(name: "Veteriner / Sağlık", icon: "cross.fill", colorHex: "#FF3B30"),
                SubCategory(name: "Pet Shop / Oyuncak", icon: "tennisball.fill", colorHex: "#FFCC00"),
        ...
        Category(
            ...
            type: .expense,
            subCategories: [
                SubCategory(name: "Kredi Kartı Borcu", icon: "creditcard.and.123", colorHex: "#8E8E93"),
                SubCategory(name: "Banka Kredisi Taksiti", icon: "dollarsign.arrow.circlepath", colorHex: "#FF3B30"),
                SubCategory(name: "Sigorta Primleri (Hayat/BES)", icon: "shield.fill", colorHex: "#34C759"),
                SubCategory(name: "Banka Komisyon / Masraf", icon: "percent", colorHex: "#636366"),
